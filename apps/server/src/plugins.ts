 ...
 * connection every other plugin assumes. `WorkspacesPlugin` and
 * `UsersPlugin` are listed after `IdentityPlugin`, whose tables they read
 * (a convention; the routes' `AuthGuard` is global and order-independent).
 */
