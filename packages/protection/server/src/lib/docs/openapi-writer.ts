 ...
 * `200` for both reads here — so a schema is written onto *that* key rather
 * than a guessed one, and a `204` (the rule delete) is left with no body
 * because that is what it sends.
 *
