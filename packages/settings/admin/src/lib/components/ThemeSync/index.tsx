 ...
 * into the app-wide {@link AppearanceProvider} once, on load. It renders nothing
 * — it exists only for the effect — and is contributed into the shell sidebar so
 * it stays mounted across every authenticated route.
 *
 ...
 * provider, so this never fights a change the user just made on the page.
 */
