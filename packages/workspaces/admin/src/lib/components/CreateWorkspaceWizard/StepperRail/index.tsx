...
export type StepperStep = {
    ...
    hint: string;
    /** Whether the step may be skipped (badged "Optional"). */
    optional?: boolean;
    /** Summary chip shown once the step is complete (e.g. the workspace name). */
    summary?: string;
};

/** Props for {@link StepperRail}. */
                ...
                return (
                    <li key={step.label} className="relative flex gap-3 pb-6 last:pb-0">
                        ...
                        <button
                            ...
                            aria-label={intl.formatMessage(messages.stepLabel, {
                                number: n,
                                label: step.label
                            })}
