...
export function WorkspaceRail({ current, workspaces }: WorkspaceRailProps) {
    ...
    return (
        <div className="sticky top-12 flex h-[calc(100svh-3rem)] w-12 shrink-0 flex-col items-center gap-1.5 self-start border-r border-border bg-[oklch(0.985_0_0)] py-2.5">
