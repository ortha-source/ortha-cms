...
/**
 * Narrows an arbitrary color string — e.g. the persisted `color` returned by
 * the workspaces read API — to a known {@link AvatarColor}, falling back to
 ...
 * accent) and spread across the palette so a roster reads as distinct.
 */
