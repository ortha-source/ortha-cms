...
describe('resolveInsightsLayout', () => {
    describe('grouping and ordering', () => {
        ...
        it('keeps registration order for items sharing an order', () => {
        ...
        it('sorts an order-less section after the built-ins', () => {
            const bands = resolve({
                sections: [
                    section({ id: 'late' }),
    ...
    describe('section contributions', () => {
        ...
        it('an override only replaces the fields it sets', () => {
        ...
        it('an override does not move the band', () => {
            const bands = resolve({
                sections: [
                    section({ id: 'content', order: 10 }),
                    section({ id: 'team', order: 20 }),
    ...
    describe('permissions', () => {
        it('drops widgets the user lacks the permission for', () => {
            const [band] = resolve({
                sections: [section({ id: 'content' })],
                widgets: [
                    widget({ id: 'open' }),
        ...
        it('drops a band whose every widget is gated out', () => {
    ...
    describe('sections nobody registered', () => {
        it('keeps the widget in a trailing catch-all band', () => {
        ...
        it('still applies permissions to orphaned widgets', () => {
            const bands = resolve({
                sections: [],
                widgets: [
                    widget({
