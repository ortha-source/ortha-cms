...
| `wysiwyg/admin`       | `@ortha-cms/wysiwyg-admin`       | The React block editor (`WysiwygEditor`) — Notion/Coda-shaped, HTML in/out, built on **TipTap 3**. Backs the `wysiwyg` content field type.                                                                                                                                                              |
