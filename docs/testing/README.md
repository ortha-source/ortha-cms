...
automated suites really cover, and what looks broken. 42 units, generated by reading
the source rather than the docs, then verified a second time against the cited lines.
...
| [`app-admin`](app-admin.md) | `apps/admin` | 3 | 9 | 6 confirmed · 0 deleted · 4 corrected · 1 unverified |
| [`bootstrap-server`](bootstrap-server.md) | `packages/bootstrap/server` | 5 | 6 | 2 confirmed · 0 deleted · 3 corrected · 1 unverified |
| [`bootstrap-admin`](bootstrap-admin.md) | `packages/bootstrap/admin` | 5 | 8 | 11 confirmed · 0 deleted · 1 corrected · 0 unverified |
...
| Artifact | Unit | 🐞 | ♿ | Verified |
| --- | --- | --- | --- | --- |
| [`database`](database.md) | `packages/database` | 5 (1H) | 1 | 3 confirmed · 0 deleted · 1 corrected · 1 unverified |
| [`utils-server`](utils-server.md) | `packages/utils/server` | 3 | 0 | 3 confirmed · 1 deleted · 0 corrected · 0 unverified |
| [`utils-admin`](utils-admin.md) | `packages/utils/admin` | 8 | 6 | 10 confirmed · 0 deleted · 1 corrected · 1 unverified |
| [`nx`](nx.md) | `packages/nx` | 7 (1H) | 4 | 7 confirmed · 0 deleted · 6 corrected · 4 unverified |
| [`design-system`](design-system.md) | `packages/design-system` | 9 | 9 | 12 confirmed · 0 deleted · 4 corrected · 1 unverified |
...
| [`identity-admin`](identity-admin.md) | `packages/identity/admin` | 5 | 12 | 12 confirmed · 0 deleted · 3 corrected · 1 unverified |
| [`users-server`](users-server.md) | `packages/users/server` | 4 | 4 | 6 confirmed · 0 deleted · 2 corrected · 0 unverified |
| [`users-admin`](users-admin.md) | `packages/users/admin` | 5 (1H) | 17 | 14 confirmed · 0 deleted · 4 corrected · 0 unverified |
| [`api-tokens-admin`](api-tokens-admin.md) | `packages/api-tokens/admin` | 5 (2H) | 13 | 12 confirmed · 0 deleted · 6 corrected · 1 unverified |
| [`activity-server`](activity-server.md) | `packages/activity/server` | 5 | 4 | 7 confirmed · 0 deleted · 1 corrected · 0 unverified |
| [`activity-admin`](activity-admin.md) | `packages/activity/admin` | 6 | 10 | 15 confirmed · 0 deleted · 1 corrected · 1 unverified |
...
| [`workspaces-admin`](workspaces-admin.md) | `packages/workspaces/admin` | 6 | 13 | 17 confirmed · 1 deleted · 3 corrected · 1 unverified |
| [`shell-admin`](shell-admin.md) | `packages/shell/admin` | 8 | 9 | 14 confirmed · 1 deleted · 1 corrected · 2 unverified |
...
| Artifact | Unit | 🐞 | ♿ | Verified |
| --- | --- | --- | --- | --- |
| [`content-domain`](content-domain.md) | `packages/content/domain` | 7 | 4 | 9 confirmed · 0 deleted · 1 corrected · 0 unverified |
| [`content-server`](content-server.md) | `packages/content/server` | 3 | 4 | 6 confirmed · 0 deleted · 0 corrected · 0 unverified |
| [`content-admin`](content-admin.md) | `packages/content/admin` | 8 (1H) | 11 | 15 confirmed · 0 deleted · 4 corrected · 0 unverified |
| [`content-graphql`](content-graphql.md) | `packages/content/graphql` | 7 (1C/2H) | 2 | 5 confirmed · 0 deleted · 2 corrected · 1 unverified |

### Localization & rich text

| Artifact | Unit | 🐞 | ♿ | Verified |
| --- | --- | --- | --- | --- |
| [`i18n-server`](i18n-server.md) | `packages/i18n/server` | 4 | 6 | 2 confirmed · 0 deleted · 5 corrected · 0 unverified |
| [`i18n-admin`](i18n-admin.md) | `packages/i18n/admin` | 8 | 12 | 16 confirmed · 0 deleted · 2 corrected · 2 unverified |
| [`wysiwyg-admin`](wysiwyg-admin.md) | `packages/wysiwyg/admin` | 4 | 11 | 4 confirmed · 0 deleted · 9 corrected · 1 unverified |

### Media

| Artifact | Unit | 🐞 | ♿ | Verified |
| --- | --- | --- | --- | --- |
| [`media-server`](media-server.md) | `packages/media/server` | 10 (1C) | 7 | 11 confirmed · 0 deleted · 3 corrected · 0 unverified |
| [`media-admin`](media-admin.md) | `packages/media/admin` | 6 | 13 | 10 confirmed · 0 deleted · 4 corrected · 0 unverified |
...
| Artifact | Unit | 🐞 | ♿ | Verified |
| --- | --- | --- | --- | --- |
| [`copilot-domain`](copilot-domain.md) | `packages/copilot/domain` | 6 | 7 | 6 confirmed · 0 deleted · 3 corrected · 0 unverified |
| [`copilot-server`](copilot-server.md) | `packages/copilot/server` | 10 (1H) | 3 | 12 confirmed · 0 deleted · 0 corrected · 1 unverified |
| [`copilot-admin`](copilot-admin.md) | `packages/copilot/admin` | 8 (2H) | 16 | 22 confirmed · 0 deleted · 1 corrected · 0 unverified |
| [`copilot-provider-anthropic`](copilot-provider-anthropic.md) | `packages/copilot/provider-anthropic` | 5 | 7 | 2 confirmed · 0 deleted · 7 corrected · 1 unverified |
| [`copilot-provider-openai`](copilot-provider-openai.md) | `packages/copilot/provider-openai` | 8 | 7 | 2 confirmed · 0 deleted · 10 corrected · 2 unverified |
| [`copilot-provider-fake`](copilot-provider-fake.md) | `packages/copilot/provider-fake` | 4 | 1 | 4 confirmed · 0 deleted · 2 corrected · 0 unverified |
| [`tools-server`](tools-server.md) | `packages/tools/server` | 5 | 6 | 3 confirmed · 0 deleted · 6 corrected · 0 unverified |
| [`mcp-server`](mcp-server.md) | `packages/mcp/server` | 5 | 7 | 9 confirmed · 0 deleted · 1 corrected · 0 unverified |

## Method and caveats

- Findings come from reading source, not from the package's own documentation — several
...
- Every finding was checked a second time against the line it cites. That pass deleted
  findings the code did not support, downgraded ones whose exploit path did not hold,
  and corrected several hundred citations.
- Severity means reachability: **Critical** and **High** require a concrete, reachable
  exploit or data-loss path in the shipped configuration. A defect that is real but
  registered in no host, or blocked by a shipped config, is downgraded and says so.
- `🔒` means authorization, tenant isolation or disclosure. Data loss and resource leaks
  are serious but are not marked `🔒`.
- The manual test plans have not been executed. They are written to be executable by
  someone with the repository and no prior context; treat them as a script to run, not
  as a record of a run.
- Accessibility is assessed to WCAG 2.1 AA with the Section 508 provision cited
  alongside, including §504 authoring-tool provisions, which is where a CMS is most
  exposed. Verdicts use VPAT language: Supports, Partially Supports, Does Not Support,
  Not Applicable.
