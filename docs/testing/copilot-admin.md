...
**♿ tally: 15 findings — 5 Does Not Support · 8 Partially Supports · 2 Not Applicable.**
...
`returnFocusRef` (`:86-87`) and never hands it down; it only calls
...
crucially **Escape**, which AGENTS.md:219-221 makes the primary dismissal — sets
